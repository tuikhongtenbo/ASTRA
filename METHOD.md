...
flowchart TD
    ...
    subgraph Auxiliary_Modules["Các Module Bổ trợ Song song"]
        direction LR
        M1["Module 1: OGM (Object-Grounded Marking)"]
        M1_Bboxes["Tọa độ Bbox O1, O2"]
        M2["Module 2: DLC (Depth-Layer Cue)"]
    ...
    subgraph Core_Reasoning["Suy luận cốt lõi & Khử Bias"]
        M3["Module 3: ODV (Order-Debiased Voting)"]
        VLM_Zero_Shot["Truy vấn Zero-shot Qwen3-VL"]
    ...
    class M1,M2,M1_Bboxes,LLM_Extractor,Entities,Marked_Image,Depth_Hint module;
